...
//                        p.$jot('.jt-content, .jt-title').css('width', 'auto');
    ...
    hiddenSubmit: function (frm, options) {
        ...
        if(options && !!options.async){
          JotForm.addWithCredentialsSupport();
          $(frm).request({
        ...
        switch (resultFieldType) {
            case "html":
                try {
                    ...
                    // encoding HTML tags in prepoluated area
  ...
  /**
    ...
    addWithCredentialsSupport: function() {
        ...
        JotForm.addWithCredentialsSupport = function() {}; // add only once.
    },
